...
try
{
    // There's multiple ways to interpret "the next three months". (A) from today till the same day of the month,
    // two months in advance, (B) the current month and the two months following it, (C) the current week starting
    // on Monday till the Sunday twelve weeks in advance. For now, I've opted for option A
    $from = Date::today();
    $till = Date::today();
